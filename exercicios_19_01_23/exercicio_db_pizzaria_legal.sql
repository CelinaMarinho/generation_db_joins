...
INSERT INTO tb_categorias(contem_gluten) VALUES(0); -- errei esse comando --
DELETE FROM `db_pizzaria_legal`.`tb_categorias` WHERE (`id` = '6');
...
VALUES ("Rúcula com tomate seco","fina","grande",79.90," ", "mussarela",1);

INSERT INTO tb_pizzas(nome, tipo_massa, tamanho, valor, proteina, queijo, categorias_id) 
VALUES ("Gomes de Sá","pan","média",69.90,"bacalhau", "mussarela",5);

INSERT INTO tb_pizzas(nome, tipo_massa, tamanho, valor, proteina, queijo, categorias_id) 
VALUES ("Banana com canela","fina","grande",63.90," ", "cream cheese",3);

INSERT INTO tb_pizzas(nome, tipo_massa, tamanho, valor, proteina, queijo, categorias_id) 
VALUES ("Cogumelo com brocólis","fina","gigante",69.90," ", "mussarela de búfala",4);

INSERT INTO tb_pizzas(nome, tipo_massa, tamanho, valor, proteina, queijo, categorias_id) 
VALUES ("Costela Gruyere","fina","grande",90.90,"costela", "mussarela e gruyere",2);
