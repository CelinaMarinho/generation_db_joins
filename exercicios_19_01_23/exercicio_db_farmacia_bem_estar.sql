...
UPDATE tb_categorias SET descricao = "produtos que agem no tratamento da pelo, corpo e cabelo" WHERE id=2;
...
UPDATE tb_produtos SET nome_produto = " Novalgina"  WHERE id=8;
